...
export const messages = Object.freeze({
  ...
  'zh-Hant': {
    ...
    page: {
      aiGuestLimit: '一般帳號每日 5 次', aiLimit: '每日 {count} 次', aiCreditsLink: 'AI 額度、交付與價格', aiCreditsNav: 'AI 額度', refundPolicyNav: '退款政策', policyNav: 'PureLink 政策', quickOpenEyebrow: '開啟', createEyebrow: '建立', readyEyebrow: '完成', reportEyebrow: '回報', managementEyebrow: '私人管理', customShortcutsLabel: '自訂公式快捷鍵', socialPreviewDescription: '重視隱私的 PureLink 短連結。在瀏覽器開啟即可查看分享內容。',
