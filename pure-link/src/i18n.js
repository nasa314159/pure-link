...
export const messages = Object.freeze({
  ...
  'zh-Hant': {
    ...
    account: { title: '我的 PureLink', intro: '只有你主動連結或登入後建立的內容會出現在這裡。匿名建立仍然可以完全不登入。', empty: '還沒有連結到這個帳號的 PureLink。', credits: '可用購買額度：{count} 次', creditsHelp: '每天 5 次免費生成會優先使用；購買額度是一次性商品，不是訂閱。', buy: 'US$5 · 購買 300 次', billingDisabled: '付款功能正在完成最後驗證，目前不會向你收費。', checkout: '正在建立安全結帳頁…', checkoutFailed: '目前無法開啟付款頁。', returned: '付款流程已返回 PureLink。', returnedHelp: '付款確認後，額度會由 Creem 的簽章通知自動加入；若尚未顯示，請稍候再重新整理。', logOut: '登出', productInfo: '商品與交付說明', refund: '退款政策' },
