...
export const messages = Object.freeze({
  en: {
    ...
    support: { title: 'Support PureLink', description: 'Optional, one-time support for PureLink’s open-source development, hosting, maintenance, and service costs.', eyebrow: 'SUPPORT PURELINK', intro: 'PureLink is free and open source. It has no ads, and support is entirely optional.', boundary: 'Support provides no AI credits, premium features, subscription, priority treatment, or other product benefit.', totals: 'Verified support received', contributions: '{count} contributions', supporters: 'Recent public supporters', limitedTotals: 'The USD figure includes only verified international contributions with a provider-reported USD total.', optionalName: 'Optional public display name', optionalNameHelp: 'Use a nickname, GitHub username, or name only if you choose to publish it. Your Google profile, billing name, and email are never published.', attribute: 'Publish this name after verified payment', optionalMessage: 'Optional public message', optionalMessageHelp: 'Keep it short. It is published only if you opt in below.', publicName: 'Publish this name after verified payment', publicMessage: 'Publish this message after verified payment', publicAmount: 'Publish this amount after verified payment', amount: 'Support amount (NT$)', customAmount: 'Enter an integer from NT$50 to NT$10,000.', amountPresets: 'Suggested amounts', ecpayMethod: 'Taiwan payment (NTD)', lemonMethod: 'International payment', internationalAmount: 'International checkout chooses its amount securely.', pending: 'We are waiting for verified payment confirmation. Returning in this browser does not record support.', history: 'Support history', emptyHistory: 'Verified support will appear here after the first completed contribution.', button: 'Support PureLink', unavailable: 'Support checkout is not available yet.', opening: 'Opening secure support checkout…', failed: 'Support checkout cannot be opened right now.', thanks: 'Thank you for supporting PureLink. Support is recorded only after a verified provider callback.', aiCredits: 'AI credits', supportAmountInvalid: 'Enter a whole-number support amount from NT$50 to NT$10,000.', supportAttributionInvalid: 'Keep the public name within 60 characters and the public message within 200 characters.' },
  ...
  'zh-Hant': {
    ...
    support: { title: '支持 PureLink', description: '可選的一次性支持，用於 PureLink 的開源開發、主機、維護與服務成本。', eyebrow: '支持 PURELINK', intro: 'PureLink 免費且開源，沒有廣告；是否支持完全由你決定。', boundary: '支持不提供 AI 額度、進階功能、訂閱、優先處理或任何其他產品權益。', totals: '已驗證收到的支持', contributions: '{count} 筆支持', supporters: '近期公開支持者', limitedTotals: '美元金額只包含付款供應商提供可靠美元金額的已驗證國際支持。', optionalName: '選填公開顯示名稱', optionalNameHelp: '只有選擇公開時才填寫暱稱、GitHub 帳號或姓名。絕不會公開你的 Google 個人資料、帳單姓名或電子郵件。', attribute: '付款經驗證後公開這個名稱', optionalMessage: '選填公開留言', optionalMessageHelp: '請保持簡短；只有在下方明確同意後才會公開。', publicName: '付款經驗證後公開這個名稱', publicMessage: '付款經驗證後公開這段留言', publicAmount: '付款經驗證後公開這個金額', amount: '支持金額（NT$）', customAmount: '請輸入 NT$50 至 NT$10,000 的整數。', amountPresets: '建議金額', ecpayMethod: '台灣付款（NTD）', lemonMethod: '國際付款', internationalAmount: '國際結帳會在安全付款頁選擇金額。', pending: '正在等待已驗證的付款確認。瀏覽器返回本身不會記錄支持。', history: '支持歷程', emptyHistory: '第一筆已完成的驗證支持後，這裡會顯示歷程。', button: '支持 PureLink', unavailable: '支持結帳目前尚未開放。', opening: '正在開啟安全支持結帳…', failed: '目前無法開啟支持結帳。', thanks: '感謝你支持 PureLink。只有已驗證的付款供應商回呼才會記錄這筆支持。', aiCredits: 'AI 額度', supportAmountInvalid: '請輸入 NT$50 至 NT$10,000 的整數支持金額。', supportAttributionInvalid: '公開名稱不得超過 60 個字元，公開留言不得超過 200 個字元。' },
