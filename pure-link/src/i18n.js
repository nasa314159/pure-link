...
export const messages = Object.freeze({
  en: {
    ...
    billing: { packs: 'One-time AI formula draft packs', packNames: { small: 'Small', standard: 'Standard', large: 'Large' }, pack: '{name}: {credits} AI formula drafts — NT${price}', providerEcpay: 'Taiwan payment — ECPay', providerLemon: 'International payment — Lemon Squeezy', providerChoice: 'Choose a payment method', paymentEnabled: 'Available payment methods: {providers}.', paymentUnavailable: 'Checkout is completing provider approval and production integration. No payment is accepted until it is enabled.', buy: 'Buy this pack', opening: 'Opening a secure checkout…', failed: 'Checkout cannot be opened right now.', billingUnavailable: 'AI credit checkout is not available yet.', billingPackInvalid: 'This AI credit pack is not available.', billingProviderInvalid: 'Choose an available payment provider.', billingProviderUnavailable: 'The checkout provider could not be reached. Please try again.', billingProviderFailed: 'The checkout provider could not create a checkout. Please try again.', supportUnavailable: 'Support checkout is not available yet.', signInRequired: 'Sign in before purchasing AI formula credits.', returned: 'The payment flow has returned to PureLink.', returnedHelp: 'Only a verified provider notification adds credits. If they are not visible yet, wait a moment and refresh.' },
    support: { title: 'Support PureLink', description: 'Optional, one-time support for PureLink’s open-source development, hosting, maintenance, and service costs.', eyebrow: 'SUPPORT PURELINK', intro: 'PureLink is free and open source. It has no ads, and contributions are entirely optional.', boundary: 'Support provides no AI credits, premium features, subscription, priority treatment, or other product benefit.', totals: 'Verified support received', contributions: '{count} contributions', supporters: 'Public supporters', limitedTotals: 'The USD total includes only verified contributions with a provider-reported USD total.', optionalName: 'Optional public display name', optionalNameHelp: 'Use a nickname, GitHub username, or name only if you want it shown publicly. Your billing name and email are never published.', attribute: 'Show this display name publicly if the contribution completes', button: 'Support PureLink', unavailable: 'Support checkout is not available yet.', opening: 'Opening secure support checkout…', failed: 'Support checkout cannot be opened right now.', thanks: 'Thank you for supporting PureLink. The contribution is recorded only after Lemon Squeezy confirms payment.', aiCredits: 'AI credits' },
    ...
    home: {
      title: 'PureLink — Privacy-friendly URL shortener and formula sharing', description: 'Shorten links without ads or needless tracking, share readable LaTeX formulas, and create quiet note cards with PureLink.', heroTitle: 'Just share.', heroLead: 'No ads. No needless data.', heroSummary: 'A privacy-friendly URL shortener for clean short links, readable LaTeX formula sharing, and quiet note cards.', authExpiredTitle: 'Sign-in time expired.', authExpiredBody: 'For account protection, this one-time sign-in expired. Start again from My PureLinks.', authFailedTitle: 'Sign-in did not finish.', authFailedBody: 'No account session was created. Please try again.', authRetry: 'Sign in again',
  ...
  'zh-Hant': {
    ...
    billing: { packs: '一次性 AI 公式草稿組合', packNames: { small: '小型方案', standard: '標準方案', large: '大型方案' }, pack: '{name}：{credits} 次 AI 公式草稿，NT${price}', providerEcpay: '台灣付款 — ECPay', providerLemon: '國際付款 — Lemon Squeezy', providerChoice: '選擇付款方式', paymentEnabled: '可用付款方式：{providers}。', paymentUnavailable: '付款功能目前正在完成供應商審核與正式整合；未啟用前不會收款。', buy: '購買此方案', opening: '正在開啟安全結帳頁…', failed: '目前無法開啟付款頁。', billingUnavailable: 'AI 額度結帳目前尚未開放。', billingPackInvalid: '這個 AI 額度方案目前無法購買。', billingProviderInvalid: '請選擇可用的付款供應商。', billingProviderUnavailable: '目前無法連線至付款供應商，請稍後再試。', billingProviderFailed: '付款供應商目前無法建立結帳頁，請稍後再試。', supportUnavailable: '支持結帳目前尚未開放。', signInRequired: '請先登入再購買 AI 公式額度。', returned: '結帳流程已返回 PureLink。', returnedHelp: '只有付款供應商驗證通知才會加入額度；若尚未顯示，請稍候重新整理。' },
    support: { title: '支持 PureLink', description: '可選的一次性支持，用於 PureLink 的開源開發、主機、維護與服務成本。', eyebrow: '支持 PURELINK', intro: 'PureLink 免費且開源，沒有廣告；是否支持完全由你決定。', boundary: '支持不提供 AI 額度、進階功能、訂閱、優先處理或任何其他產品權益。', totals: '已驗證收到的支持', contributions: '{count} 筆支持', supporters: '公開支持者', limitedTotals: '美元總額只包含付款供應商提供可靠美元總額的已驗證支持。', optionalName: '選填公開顯示名稱', optionalNameHelp: '只有想公開顯示時才填寫暱稱、GitHub 帳號或姓名。絕不會公開你的帳單姓名或電子郵件。', attribute: '若支持完成，公開顯示這個名稱', button: '支持 PureLink', unavailable: '支持結帳目前尚未開放。', opening: '正在開啟安全支持結帳…', failed: '目前無法開啟支持結帳。', thanks: '感謝你支持 PureLink。只有 Lemon Squeezy 確認付款後才會記錄這筆支持。', aiCredits: 'AI 額度' },
    ...
    home: {
      title: 'PureLink — 不追蹤的短網址、公式與小卡分享', description: '用 PureLink 建立不含廣告與不必要追蹤的短網址，分享清楚的 LaTeX 公式與安靜的小卡。', heroTitle: '安心分享。', heroLead: '沒有廣告，沒有不必要的資料。', heroSummary: '不追蹤的短網址、清楚的 LaTeX 公式分享，以及安靜的小卡。', authExpiredTitle: '登入等待時間已結束。', authExpiredBody: '為了保護帳戶，這次的一次性登入已失效；請從「我的 PureLink」重新開始。', authFailedTitle: '這次登入沒有完成。', authFailedBody: '沒有建立任何帳戶工作階段，請重新嘗試。', authRetry: '重新登入',
