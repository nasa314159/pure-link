...
export const messages = Object.freeze({
  ...
  'zh-Hant': {
    ...
    support: { title: '支持 PureLink', description: '可選的一次性支持，用於 PureLink 的開源開發、主機、維護與服務成本。', eyebrow: '支持 PURELINK', intro: 'PureLink 免費且開源，沒有廣告；是否支持完全由你決定。', boundary: '支持不提供 AI 額度、進階功能、訂閱、優先處理或任何其他產品權益。', totals: '已驗證收到的支持', contributions: '{count} 筆支持', supporters: '近期公開支持者', limitedTotals: '美元金額只包含付款供應商提供可靠美元金額的已驗證國際支持。', optionalName: '選填公開顯示名稱', optionalNameHelp: '只有選擇公開時才填寫暱稱、GitHub 帳號或姓名。絕不會公開你的 Google 個人資料、帳單姓名或電子郵件。', attribute: '付款經驗證後公開這個名稱', optionalMessage: '選填公開留言', optionalMessageHelp: '請保持簡短；只有在下方明確同意後才會公開。', publicName: '付款經驗證後公開這個名稱', publicMessage: '付款經驗證後公開這段留言', publicAmount: '付款經驗證後公開這個金額', amount: '支持金額（NT$）', customAmount: '請輸入 NT$50 至 NT$10,000 的整數。', amountPresets: '建議金額', ecpayMethod: '台灣付款（NTD）', ecpayDescription: '選擇支持金額，付款將透過綠界安全結帳。', lemonMethod: '國際付款', internationalAmount: '國際結帳會在安全付款頁選擇金額。', pending: '正在等待已驗證的付款確認。瀏覽器返回本身不會記錄支持。', history: '支持歷程', emptyHistory: '第一筆已完成的驗證支持後，這裡會顯示歷程。', button: '支持 PureLink', unavailable: '支持結帳目前尚未開放。', opening: '正在開啟安全支持結帳…', failed: '目前無法開啟支持結帳。', thanks: '感謝你支持 PureLink。只有已驗證的付款供應商回呼才會記錄這筆支持。', aiCredits: 'AI 額度', supportAmountInvalid: '請輸入 NT$50 至 NT$10,000 的整數支持金額。', supportAttributionInvalid: '公開名稱不得超過 60 個字元，公開留言不得超過 200 個字元。' },
