...
Lemon Squeezy 只處理 AI 公式額度商品，不處理沒有商品對價的自願支持。自願支持與 AI 額度在介面、帳務和公開說明中保持分離。正式購買功能會在商家審核、測試付款、簽章驗證、重複通知防護與退款流程完成後才啟用。公開商品與退款說明位於 `/ai-credits` 與 `/refund-policy`。
